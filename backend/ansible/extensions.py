...
# Known extension keys (mapping to NodeConfig / GroupConfig fields)
HOST_EXTENSION_KEYS = {
    "racksmith_name",
    "racksmith_managed",
    "racksmith_notes",
    ...
    "racksmith_labels",
    "racksmith_rack",
    "racksmith_position_u_start",
    "racksmith_position_u_height",
    "racksmith_position_col_start",
    "racksmith_position_col_count",
}
