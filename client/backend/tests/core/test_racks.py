...
class TestReadRacks:
    ...
    def test_parses_racks_from_meta(self, layout) -> None:
...
class TestRemoveRack:
    ...
    def test_removes_rack_from_meta(self, layout) -> None:
        _write_racksmith_yml(layout, {
            "schema_version": 3,
            "racks": {
