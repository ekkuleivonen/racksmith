...
from ansible.roles import read_role, write_role
from repos.schemas import DetectedAnsiblePaths, ImportAnsibleSummary
            ...
            for sub in src.iterdir():
                if sub.is_dir() and not sub.name.startswith("."):
                    ...
                    if role is not None:
                        tasks_content = None
                        try:
                            from ansible.roles import read_role_tasks
