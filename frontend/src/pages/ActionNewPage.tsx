...
const LLM_PROMPT = `You are generating a Racksmith action YAML. Output a single YAML document. Do not include markdown code fences.

## Rules
- slug: lowercase, hyphens only, no spaces (e.g. install-docker, setup-node-exporter)
- name: title case, short
- One action = one concern
    ...
    <div className="flex-1 min-h-0 overflow-auto p-6">
      <div className="max-w-3xl mx-auto space-y-6">
        <div className="space-y-1">
          <h1 className="text-zinc-100 font-semibold">Import action</h1>
          <p className="text-xs text-zinc-500">
            Copy the prompt below into an LLM to generate action YAML. Paste the
