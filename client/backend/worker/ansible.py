"""Ansible runtime helpers for the worker."""
...
async def install_ansible_collections_on_startup(
    ...
    """Install Ansible collections listed in ANSIBLE_EXTENSIONS."""
    ...
    if process.returncode != 0:
        logger.error(
            "ansible_extensions_install_failed",
    ...
    logger.info(
        "ansible_extensions_install_done",
        return_code=process.returncode,
        output=output,
    )
